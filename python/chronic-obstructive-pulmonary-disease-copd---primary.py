...
codes = [{"code":"H38..00","system":"readv2"},{"code":"H37..00","system":"readv2"},{"code":"H3z..11","system":"readv2"},{"code":"H36..00","system":"readv2"},{"code":"66YI.00","system":"readv2"},{"code":"66YM.00","system":"readv2"}];
REQUIRED_CODES = 1;
